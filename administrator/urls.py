...
urlpatterns = [
  path('terminalenrollment', views.terminalEnrollment, name='terminalenrollment'),
  ...
  path('student-by-class', views.studentsByClass, name='student-by-class'),
  path('export-admission-list/<str:session>/<str:classroom>/<str:term>', views.exportAdmissionList, name='export-admission'),
  path('export-students/<str:session>/<str:classroom>/<str:term>', views.exportStudents, name='export-students'),
  ...
  path('print-terminal-summary/<str:term>/<str:session>/<str:classroom>', views.printTerminalResultSummary, name='print-terminal-summary'),
  
  path('annualresult-summary', views.AnnualResultSummary, name='annualresult-summary'),
  
  path('print-annual-summary/<str:session>/<str:classroom>', views.PrintAnnualResultSummary, name='print-annual-summary'),
