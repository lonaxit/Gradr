...
class Scores(models.Model):
    ...
    highest_inclass = models.DecimalField(max_digits=4, decimal_places=2,null=True,blank=True)
    lowest_inclass =  models.DecimalField(max_digits=4, decimal_places=2,null=True,blank=True)
...
class Result(models.Model):
    ...
    termtotal = models.DecimalField(max_digits=4, decimal_places=2,null=True,blank=True)
    termaverage = models.DecimalField(max_digits=4, decimal_places=2,null=True,blank=True)
...
class Rating(models.Model):
    description = models.DecimalField(max_digits=4, decimal_places=2,null=True,blank=True)
...
class Studentpsychomotor(models.Model):
    ...
    studentclass = models.ForeignKey("administrator.StudentClass",on_delete=models.DO_NOTHING)
    classteacher = models.ForeignKey("administrator.ClassTeacher",on_delete=models.DO_NOTHING)
    pyschomotor = models.ForeignKey(Psychomotor,on_delete=models.DO_NOTHING)
    rating = models.ForeignKey(Rating,on_delete=models.DO_NOTHING)
    date_created = models.DateTimeField(auto_now_add=True,null=True)
    date_modified = models.DateTimeField(auto_now=True)
    def __str__(self):
